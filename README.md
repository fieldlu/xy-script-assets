...
| [zygame1314](https://gitee.com/zygame1314) | 灵感参考 | 大量开源项目参考与接口思路启发 |
| [Qy](https://qyovo.tech/) | 核心参考 | 刷课功能的实现参考了大量相关实现与思路 |
...
- **zygame1314**：感谢 zygame1314 的开源项目和接口参考，为脚本的实现提供了重要的思路借鉴。
- **Qy**：感谢 Qy（qyovo.tech）的开源项目与实现参考，刷课功能的核心流程从中获得了重要启发。
